import HsvToHex from "@/app/_components/tools/color-tools/HsvToHex/page"

export const generateMetadata = () => {
    const toolName = "HSV to HEX Converter";
    const toolDescription = "Convert HSV color values to HEX codes effortlessly with our free online HSV to HEX Converter tool. Perfect for designers and developers working with color conversions!";
    const toolUrl = "https://www.codercrafter.in/tools/color-converters/hsv-to-hex";
    const toolImage = "https://codercrafter.in/assets/images/tools_codercrafter.png";

    return {
        title: `${toolName} | Free Online HSV to HEX Color Converter`,
...
const HsvToHexPage = () => {
    return <div className="container">
        <div className="w-full">
            <h1 style={{ fontWeight: 600 }} className="text-4xl">HSV to HEX Converter</h1>
            {/* Replace with your HSV to HEX Converter component */}
            <HsvToHex />
            <div className="mt-10 flex flex-wrap justify-center">
                <div className="md:w-1/2 flex flex-col gap-10">
                    <div className="flex flex-col gap-10">
                        <div>
                            <h2 className="text-4xl">What is an HSV to HEX Converter?</h2>
                            <p>
                                An HSV to HEX Converter is a tool that transforms HSV (Hue, Saturation, Value) color values into HEX (Hexadecimal) format. This conversion is essential for designers and developers who need to switch between color manipulation (HSV) and digital (HEX) systems.
                            </p>
                        </div>
                        <div>
                            <h3 className="text-3xl">🚀 Why Convert HSV to HEX?</h3>
                            <p>Converting HSV to HEX can be beneficial for several reasons:</p>
                            <ul>
                                ...
                                <li>✅ Simplification: Converts intuitive HSV values into a web-friendly HEX format.</li>
                            </ul>
                        </div>
                    </div>
                    <div>
                        <h2 className="text-3xl">Features of Our HSV to HEX Converter</h2>
                        <ul>
                            <li>🔹 Instant Conversion – Convert HSV to HEX in real-time.</li>
                    ...
                    <div>
                        <h2 className="text-3xl">How to Use the HSV to HEX Converter?</h2>
                    ...
                    <div>
                        <h2 className="text-3xl">Why Choose Codercrafter’s HSV to HEX Converter?</h2>
                        <ul>
                            <li>✨ Lightning Fast: Convert HSV to HEX in seconds.</li>
            ...
            <div className="w-full flex flex-col items-center gap-1 p-5">
                <div className="w-2/3 flex flex-col border border-gray-600 gap-2">
                    <span className="bg-gray-400 text-2xl text-white-800">🔹 Is HSV to HEX Conversion Accurate?</span>
                    <span>Yes! The converter ensures precise color matching between HSV and HEX formats.</span>
                </div>
                <div className="w-2/3 flex flex-col border border-gray-600 gap-2">
                    <span className="bg-gray-400 text-2xl text-white-800">🔹 Can I Convert HEX Back to HSV?</span>
                    <span>Yes! You can use a HEX to HSV converter to restore the original HSV values.</span>
                </div>
