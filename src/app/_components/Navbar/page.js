...
const Navbar = () => {
    ...
    return <>
        <header
            ref={navbarRef}
            className={`uk-sticky uk-sticky-fixed ${getPathName == "/" ? "backdrop-filter backdrop-blur-2xl is-dark" : ""} ${scrollPercent < 5 && getPathName == "/" ? "is-transparent" : ""} border-b`}
            uk-sticky={`${getPathName == "/" ? "cls-inactive: is-dark is-transparent border-b" : ""}`}
            ...
            <div className="header_inner" bis_skin_checked={1}>
                <div className="left-side" bis_skin_checked={1}>
                    ...
                    <div id="logo" bis_skin_checked={1}>
                        <a href="/">
                            <img style={{ height: 50 }} src="/assets/images/codecrafter_logo.png" className="h-[50px] w-auto md:h-[70px]" alt="Codecrafter Institute - Expert Training in Mean Stack, Mern Stack, NextJS, and DevOps (AWS, Azure) for IT Students and Professionals." />
                            <img
                                style={{ height: 50, width: "auto" }}
                                src="/assets/images/codecrafter_logo.png"
                                className="logo_inverse h-[50px] w-auto md:h-[70px]"
                                ...
                                >
                                    <ul>
                                        <li>
                                            ...
                                            <a href="/courses/5/aws-cloud-computing-course" style={{ textDecoration: "none", color: "rgba(0, 0, 0, 0.7)" }} >
                                        ...
                                        <li>
                                            ...
                                            <a href="/courses/7/mern-stack-developer" style={{ textDecoration: "none", color: "rgba(0, 0, 0, 0.7)" }} >
                                        ...
                                        <li>
                                            ...
                                            <a href="/courses/2/nextjs-developer-course" style={{ textDecoration: "none", color: "rgba(0, 0, 0, 0.7)" }} >
                                        ...
                                        <li>
                                            ...
                                            <a href="/courses/6/azure-training-certification" style={{ textDecoration: "none", color: "rgba(0, 0, 0, 0.7)" }} >
                ...
                <div style={{ display: "flex", alignItems: "center" }} className="right-side" bis_skin_checked={1}>
                    {getPathName == "/" && <a style={{ textDecoration: "none", background: "linear-gradient(to right, #5e548e, #9f86c0)", color: "white", padding: 8, borderRadius: 6, display: "flex", alignItems: "center", gap: 8 }} className="phone_num" href="tel:+9131958847" >
