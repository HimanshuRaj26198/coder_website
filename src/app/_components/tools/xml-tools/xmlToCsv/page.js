...
const XmlToCsvConverter = () => {
    ...
    const handleInputChange = (e) => {
        ...
        xmlToJson(xml)
            .then((parsedData) => {
                const csv = jsonToCsv(parsedData); // Convert JSON to CSV
                setCsvData(csv); // Set the parsed CSV data
                setErrorMessage("");
                setErrorLine(null);
                setErrorDetail("");
                setShowError(false);
                ...
                <div className="grid grid-cols-2 w-full gap-5">
                    ...
                    <div className="border border-gray-300 rounded-lg overflow-hidden">
                        <div className="bg-gray-800 p-2 flex justify-end space-x-4">
                            ...
                            <span onClick={() => handleCopy(csvData || "")} className="cursor-pointer text-white">
                                <Copy size={25} />
                            </span>
                        ...
                        <div className="flex">
                            ...
                            >
                                {csvData ? (
                                    ...
                                    <div className="text-gray-500">CSV will be generated after conversion.</div>
                                )}
                            </div>
                        </div>
                    </div>
