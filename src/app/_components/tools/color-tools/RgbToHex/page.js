                ...
                <div className="column is-12">
                    ...
                    <div className="columns">
                        ...
                        <div className="column">
                            {/* <h1 className="title has-text-centered">RGB to HEX Converter</h1> */}
                        </div>
                    ...
                    <div className="columns">
                        <div className="column is-2">
                            ...
                            >
                                <code id="previewColorCode">{previewHex}</code>
                            </div>
                        </div>
                    ...
                    <div className="columns is-centered">
                        <div className="column is-8 has-text-centered">
                            <div className="box">
                                ...
                                <p className="is-size-4" style={{ background: previewHex, color: "white" }}>
                                    {previewHex}
                                </p>
                            </div>
                        </div>
